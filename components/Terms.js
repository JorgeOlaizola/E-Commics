...
const Terms = () => {
    return(
        <StyledContainer>
            <h2>Términos y condiciones de uso de Ecommics</h2>
            <StyledTextBox>
                ...
                Los servicios brindados por Ecommics están únicamente disponibles para personas mayores de 18 (dieciocho) años de edad y/o aquellas tiendas oficiales que acrediten ante la Administración la documentación correspondiente.

                <br/><br/><strong>02 - Registro</strong><br/><br/>
                El Usuario deberá completar todos los campos requeridos en el formulario de registro con información real y se compromete a actualizar los mismos oportunamente. Ecommics no se responsabiliza por la certeza de los datos provistos por el Usuario, siendo ésta expresa responsabilidad suya.
                En caso de la inhabilitación del Usuario, se darán de baja todas las publicaciones que el mismo haya realizado.
                La cuenta de Ecommics tiene carácter de única e intransferible, por lo que el Usuario podrá poseer únicamente UNA, quedando penada la ruptura de esta norma con la inhabilitación (por tiempo indeterminado) del Usuario.  

                <br/><br/><strong>03 - Modificaciones del Acuerdo</strong><br/><br/>
                Ecommics podrá modificar en cualquier momento el contenido de sus términos y condiciones de uso, quedando exento de cualquier reclamo al respecto y teniendo la obligación de comunicarlo a sus Usuarios a través de los canales de comunicación propios del sitio.
